...
class ImageConverterApp:
    ...
    def select_output_folder(self):
        try:
            ...
            self.output_folder_path = filedialog.askdirectory(initialdir="~/Download", title="Seleccionar Carpeta de Destino")
    ...
    def show_preview(self):
        if self.filepath:
            try:
                ...
                messagebox.showerror("Error", f"No se pudo cargar la imagen para previsualización: {str(e)}")
